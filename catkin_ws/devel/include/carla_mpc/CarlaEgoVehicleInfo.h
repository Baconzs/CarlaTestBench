// Generated by gencpp from file carla_mpc/CarlaEgoVehicleInfo.msg
// DO NOT EDIT!


#ifndef CARLA_MPC_MESSAGE_CARLAEGOVEHICLEINFO_H
#define CARLA_MPC_MESSAGE_CARLAEGOVEHICLEINFO_H
...
#include <carla_mpc/CarlaEgoVehicleInfoWheel.h>
...
struct CarlaEgoVehicleInfo_
{
  ...
  _rolename_type rolename;
   ...
   typedef std::vector< ::carla_mpc::CarlaEgoVehicleInfoWheel_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::carla_mpc::CarlaEgoVehicleInfoWheel_<ContainerAllocator> >> _wheels_type;
  _wheels_type wheels;
  ...
  typedef boost::shared_ptr< ::carla_mpc::CarlaEgoVehicleInfo_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::carla_mpc::CarlaEgoVehicleInfo_<ContainerAllocator> const> ConstPtr;

}; // struct CarlaEgoVehicleInfo_

typedef ::carla_mpc::CarlaEgoVehicleInfo_<std::allocator<void> > CarlaEgoVehicleInfo;

typedef boost::shared_ptr< ::carla_mpc::CarlaEgoVehicleInfo > CarlaEgoVehicleInfoPtr;
typedef boost::shared_ptr< ::carla_mpc::CarlaEgoVehicleInfo const> CarlaEgoVehicleInfoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::carla_mpc::CarlaEgoVehicleInfo_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::carla_mpc::CarlaEgoVehicleInfo_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::carla_mpc::CarlaEgoVehicleInfo_<ContainerAllocator1> & lhs, const ::carla_mpc::CarlaEgoVehicleInfo_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::carla_mpc::CarlaEgoVehicleInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::carla_mpc::CarlaEgoVehicleInfo_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::carla_mpc::CarlaEgoVehicleInfo_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::carla_mpc::CarlaEgoVehicleInfo_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::carla_mpc::CarlaEgoVehicleInfo_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::carla_mpc::CarlaEgoVehicleInfo_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::carla_mpc::CarlaEgoVehicleInfo_<ContainerAllocator> >
{
  ...
  static const char* value(const ::carla_mpc::CarlaEgoVehicleInfo_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x7635942a53dfdf0eULL;
  static const uint64_t static_value2 = 0xdbbafc9eea467602ULL;
};

template<class ContainerAllocator>
struct DataType< ::carla_mpc::CarlaEgoVehicleInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::carla_mpc::CarlaEgoVehicleInfo_<ContainerAllocator> >
{
  static const char* value()
  {
    return "#\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::carla_mpc::CarlaEgoVehicleInfo_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::carla_mpc::CarlaEgoVehicleInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::carla_mpc::CarlaEgoVehicleInfo_<ContainerAllocator>& v)
  {
    s << indent << "id: ";
    ...
    for (size_t i = 0; i < v.wheels.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::carla_mpc::CarlaEgoVehicleInfoWheel_<ContainerAllocator> >::stream(s, indent + "    ", v.wheels[i]);
    }
    s << indent << "max_rpm: ";
...
#endif // CARLA_MPC_MESSAGE_CARLAEGOVEHICLEINFO_H

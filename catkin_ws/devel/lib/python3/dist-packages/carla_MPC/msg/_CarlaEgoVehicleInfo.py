...
"""autogenerated by genpy from carla_MPC/CarlaEgoVehicleInfo.msg. Do not edit."""
import codecs
import sys
...
float64 z"""
  ...
  _slot_types = ['uint32','string','string','carla_MPC/CarlaEgoVehicleInfoWheel[]','float32','float32','float32','float32','float32','bool','float32','float32','float32','float32','geometry_msgs/Vector3']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = carla_MPC.msg.CarlaEgoVehicleInfoWheel()
        _x = val1
        start = end
        end += 24
